...
import { KeyRound, CheckCircle2, ShieldCheck, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md flex flex-col items-center">
        ...
        <p className="mt-1 text-center text-xs text-zinc-400">
          Sent 6-digit PIN to <span className="font-mono text-emerald-400 font-semibold">{phone}</span>
        </p>
      </div>
